...
export function createHighlightHTML(
  highlights: Highlight[],
  node: HTMLElement,
  ...
  const altered = inside.map((insideText, i) => {
    ...
    return markHTML(
      ...
      lastInSpan,
    ); //onHighlightMount, focusComment, lastInSpan);
  });
